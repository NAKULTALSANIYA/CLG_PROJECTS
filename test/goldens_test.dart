...
void main() {
  ...
  testWidgets('Explore screen golden', (tester) async {
    await _setGoldenSize(tester);
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: ExploreScreen())));
    await tester.pumpAndSettle();
  ...
  testWidgets('Favorites screen golden', (tester) async {
    await _setGoldenSize(tester);
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: FavoritesScreen())));
    await tester.pumpAndSettle();
  ...
  testWidgets('Profile screen golden', (tester) async {
    await _setGoldenSize(tester);
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: ProfileScreen())));
    await tester.pumpAndSettle();
